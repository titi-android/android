...
public val MyIconPack.IcSetting: ImageVector
    get() {
        if (_icSetting != null) {
            return _icSetting!!
        }
        _icSetting = Builder(name = "IcSetting", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(19.2264f, 8.7308f)
                ...
                curveTo(19.9676f, 16.7295f, 19.9676f, 17.5105f, 19.49f, 18.0f)
                lineTo(17.99f, 19.5f)
                ...
                curveTo(6.8805f, 19.9776f, 6.0995f, 19.9776f, 5.61f, 19.5f)
                lineTo(4.11f, 18.0f)
                curveTo(3.6324f, 17.5105f, 3.6324f, 16.7295f, 4.11f, 16.24f)
                curveTo(4.4661f, 15.8865f, 4.574f, 15.3534f, 4.3836f, 14.8892f)
                curveTo(4.1931f, 14.4251f, 3.7417f, 14.1215f, 3.24f, 14.12f)
                curveTo(2.9111f, 14.12f, 2.5957f, 13.9894f, 2.3632f, 13.7568f)
                curveTo(2.1306f, 13.5243f, 2.0f, 13.2089f, 2.0f, 12.88f)
                verticalLineTo(10.74f)
                curveTo(2.0f, 10.0552f, 2.5552f, 9.5f, 3.24f, 9.5f)
                curveTo(3.7417f, 9.4985f, 4.1931f, 9.1949f, 4.3836f, 8.7308f)
                curveTo(4.574f, 8.2666f, 4.4661f, 7.7335f, 4.11f, 7.38f)
                curveTo(3.6324f, 6.8906f, 3.6324f, 6.1094f, 4.11f, 5.62f)
                lineTo(5.61f, 4.12f)
                curveTo(6.0995f, 3.6424f, 6.8805f, 3.6424f, 7.37f, 4.12f)
                curveTo(7.5958f, 4.3592f, 7.9111f, 4.4933f, 8.24f, 4.49f)
                curveTo(8.5723f, 4.4927f, 8.8919f, 4.3619f, 9.1269f, 4.1269f)
                curveTo(9.3619f, 3.8918f, 9.4927f, 3.5723f, 9.49f, 3.24f)
                curveTo(9.49f, 2.5552f, 10.0452f, 2.0f, 10.73f, 2.0f)
                horizontalLineTo(12.88f)
                curveTo(13.5648f, 2.0f, 14.12f, 2.5552f, 14.12f, 3.24f)
                ...
                curveTo(16.7294f, 3.6424f, 17.5105f, 3.6424f, 18.0f, 4.12f)
                lineTo(19.5f, 5.62f)
                ...
                curveTo(13.9429f, 5.9865f, 12.7586f, 4.9103f, 12.62f, 3.5f)
                horizontalLineTo(10.98f)
                curveTo(10.8458f, 4.9126f, 9.6589f, 5.9912f, 8.24f, 5.99f)
                ...
                curveTo(9.6572f, 17.6335f, 10.8414f, 18.7096f, 10.98f, 20.12f)
