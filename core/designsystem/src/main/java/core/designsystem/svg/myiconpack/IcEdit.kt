...
public val MyIconPack.IcEdit: ImageVector
    get() {
        if (_icEdit != null) {
            return _icEdit!!
        }
        _icEdit = Builder(name = "IcEdit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.7901f, 15.2699f)
                lineTo(8.5201f, 11.8599f)
                curveTo(8.6264f, 11.3861f, 8.8657f, 10.9524f, 9.2101f, 10.6099f)
                lineTo(15.8801f, 3.9999f)
                ...
                lineTo(8.7301f, 16.2699f)
                horizontalLineTo(8.5401f)
