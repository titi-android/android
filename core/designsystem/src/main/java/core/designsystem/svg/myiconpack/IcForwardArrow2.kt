...
public val MyIconPack.IcForwardArrow2: ImageVector
    get() {
        if (_icForwardArrow2 != null) {
            return _icForwardArrow2!!
        }
        _icForwardArrow2 = Builder(name = "IcForwardArrow2", defaultWidth = 18.0.dp, defaultHeight =
...
private var _icForwardArrow2: ImageVector? = null
