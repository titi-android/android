...
enum class BusType(val type: String, val color: Color, val colorT1: Color, val colorT2: Color, val iconColor: Color) {
    ...
    급행("급행", Color(0xFFE65F51 ), Color(0xFF7A0000), Color(0xFFFFDDD9 ), Color(0xFFE86F62 )),
    광역("광역", Color(0xFFE65F51 ), Color(0xFF7A0000), Color(0xFFFFDDD9 ), Color(0xFFE86F62 )),
    직행("직행", Color(0xFFE65F51 ), Color(0xFF7A0000), Color(0xFFFFDDD9 ), Color(0xFFE86F62 )),
